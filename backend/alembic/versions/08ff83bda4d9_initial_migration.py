...
Revision ID: 08ff83bda4d9
Revises: 
Create Date: 2025-04-13 13:50:27.446846
...
def upgrade() -> None:
    ...
    sa.Column('book_cover_photo', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    ...
    sa.Column('order_amount', sa.Numeric(precision=8, scale=2), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
